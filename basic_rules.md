...
| --- | --- |
| Weapon +1/+2/+3 | Wyjątek 1: Każdą broń można przekuć na broń +1/+2/+3 (z zachowaniem ograniczeń ogólnych) tracąc wszystkie własności magiczne wyjściowej broni i zastępując je odpowiednim bonusem do trafienia i obrażeń.<br /> Wyjątek 2: Broń przekuwana na broń +1/+2/+3 może uzyskać cechy _finesse_.<br /> Wyjątek 3: przedmioty Wraps of Unarmed Prowess o rzadkości Uncommon i Insignia of Claws liczą się jako broń o cesze Simple na potrzeby tej zasady. |
